...
В рамках задач текущего манула нам понадобится текстовый редактор. Автор мануала использует `helix editor`, но для новичков, на которых ориентирован данный мануал на первых парах будет проще и надежнее VS Code. Его мы сейчас установим. Скачиваем установщик с сайта:
