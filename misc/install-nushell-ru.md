...
В рамках задач текущего мануала нам понадобится текстовый редактор. Автор мануала использует `helix editor`, но для новичков, на которых ориентирован данный мануал, поначалу будет проще и надежнее VS Code. Именно его мы сейчас установим. Скачайте установщик с сайта:
